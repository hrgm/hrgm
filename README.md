...
クラウド戦略・プラットフォーム戦略のコンサルタントを一旦の最終目標として、まずはこれまでのアプリ開発経験を活かしてアプリ基盤寄りのクラウドアーキテクトを目指しています。

直近の活動としては、業務で扱っているアジャイル開発 (スクラム) と Microsoft Azure をしっかり学ぶため、各種資格取得を通して体系的な学習を行っています。
